...
export default function main() {
  ...
  getMediaContent(mediaSource);
  function getMediaContent(mediaSource) {
    mediaSource.addEventListener(
      ...
      function() {
        ...
        processFile(sourceBuffer, mediaSource, video);
        function processFile(sourceBuffer, mediaSource, video) {
          ...
          get(FILE, function(uInt8Array) {
            ...
            (function readChunk_(i) {
              ...
              reader.onload = e => appendToBuffer(e, sourceBuffer, video);
              function appendToBuffer(e, sourceBuffer, video) {
